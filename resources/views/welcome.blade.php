...
<head>
    ...
    <title>Inventory with Point of Sale </title>
    <!-- Favicon Icon -->
    <link rel="icon" href="{{ asset('frontpage/assets/img/favicon.svg') }}">
    <!-- CSS plugins files -->
    ...
    <link rel="stylesheet" href="{{ asset('frontpage/assets/css/animate.css') }}">
    <!-- Custome CSS -->
...
<body>
    ...
    <header class="cs_site_header cs_style_1 cs_text_white cs_sticky_header cs_medium">
        <div class="cs_main_header">
            <div class="container">
                <div class="cs_main_header_in">
                    <div class="cs_main_header_left">
                        <a class="cs_site_branding" href="/">
                            <img src="{{ asset('backend/assets/img/logo-white.png') }}" alt="Logo">
                        </a>
                    </div>
                    ...
                    <div class="cs_main_header_right">
                        <div class="cs_header_btns">
                            <a href="{{ route('login') }}" class="cs_header_text_btn cs_modal_btn">Login</a>
                            <a href="{{ route('register') }}" class="cs_btn cs_bg_accent cs_modal_btn">Sign Up</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="cs_content">
        ...
        <section class="cs_hero cs_style_1 position-relative" id="home">
            <div class="container">
                ...
                <div class="cs_hero_img wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.25s">
                    <img src="{{ asset('frontpage/assets/img/showcase.png') }}" alt="Thumbnail">
                </div>
            </div>
            <div class="cs_hero_shape1"></div>
            <div class="cs_hero_shape2">
                <img src="{{ asset('frontpage/assets/img/Polygon.svg') }}" alt="Polygon Icon">
            </div>
            ...
            <div class="container">
                ...
                <div class="row cs_gap_y_30 wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s">
                    <div class="col-lg-6 col-xl-3">
                        <div class="cs_iconbox cs_style_1">
                            <div class="cs_iconbox_icon">
                                <img src="{{ asset('frontpage/assets/img/shop.svg') }}" alt="Icon">
                            </div>
                            <h3 class="cs_iconbox_title">Suitable For All Types Businesses</h3>
                            <p class="cs_iconbox_subtitle">Voilla satisfaction spares over the quitting even disguised I just of to
                                I
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="cs_iconbox cs_style_1">
                            <div class="cs_iconbox_icon">
                                <img src="{{ asset('frontpage/assets/img/price_bar.svg') }}" alt="Icon">
                            </div>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="cs_iconbox cs_style_1">
                            <div class="cs_iconbox_icon">
                                <img src="{{ asset('frontpage/assets/img/setup.svg') }}" alt="Icon">
                            </div>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="cs_iconbox cs_style_1">
                            <div class="cs_iconbox_icon">
                                <img src="{{ asset('frontpage/assets/img/ui.svg') }}" alt="Icon">
                            </div>
                ...
                <div class="cs_featured_shape">
                    <img src="{{ asset('frontpage/assets/img/Vector.svg') }}" alt="">
                </div>
            </div>
                ...
                <div class="row align-items-center cs_gap_y_40">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="cs_pr_45 text-center">
                            <img src="{{ asset('frontpage/assets/img/illustartion1.svg') }}" alt="">
                        </div>
                    </div>
                ...
                <div class="row align-items-center cs_gap_y_40 cs_reverse_lg">
                        ...
                        <ul class="cs_list cs_style_1 cs_mp0">
                            <li>
                                <span class="cs_list_icon">
                                    <img src="{{ asset('frontpage/assets/img/arrow.svg') }}" alt="Icon">
                                </span>
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="cs_feature_thumb_1 text-center">
                            <img src="{{ asset('frontpage/assets/img/illustartion.svg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="pricing" class="cs_section_shape_wrap_1 cs_gradient_bg_1 position-relative overflow-hidden">
            <div class="cs_section_shape_1 position-absolute">
                <img src="{{ asset('frontpage/assets/img/Vector3.svg') }}" alt="Shape">
            </div>
            <div class="cs_section_shape_2 position-absolute">
                <img src="{{ asset('frontpage/assets/img/dot.svg') }}" alt="Shape">
            </div>
            <div class="cs_height_143 cs_height_lg_75"></div>
            <div class="container">
                ...
                <div class="row cs_gap_y_30 wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        ...
                        <div class="cs_pricing_table cs_style_1">
                            <div class="cs_pricing_head">
                                <div class="cs_pricing_icon">
                                    <img src="{{ asset('frontpage/assets/img/symbol.svg') }}" alt="">
                                </div>
                                <div class="cs_pricing_head_text">
                                    <h3 class="cs_pricing_head_title">
                                        Starter
                                    </h3>
                    ...
                    <div class="col-lg-4">
                        <div class="cs_pricing_table cs_style_1 active">
                            <div class="cs_pricing_head">
                                <div class="cs_pricing_icon">
                                    <img src="{{ asset('frontpage/assets/img/symbol1.svg') }}" alt="">
                                </div>
                                <div class="cs_pricing_head_text">
                                    <h3 class="cs_pricing_head_title">
                                        Standard
                    ...
                    <div class="col-lg-4">
                        <div class="cs_pricing_table cs_style_1">
                            <div class="cs_pricing_head">
                                <div class="cs_pricing_icon">
                                    <img src="{{ asset('frontpage/assets/img/symbol3.svg') }}" alt="">
                                </div>
                                <div class="cs_pricing_head_text">
                                    <h3 class="cs_pricing_head_title">
                                        Professional
        ...
        <section id="testimonial">
            ...
            <div class="cs_slider wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <div class="cs_testimonial cs_style_1">
                    <div class="cs_client_info">
                        <div class="cs_client_img">
                            <img src="{{ asset('frontpage/assets/img/user1.png') }}" alt="avatar1">
                        </div>
                ...
                <div class="cs_testimonial cs_style_1">
                    <div class="cs_client_info">
                        <div class="cs_client_img">
                            <img src="{{ asset('frontpage/assets/img/user2.png') }}" alt="avatar1">
                        </div>
                        <div class="cs_client_meta">
                ...
                <div class="cs_testimonial cs_style_1">
                    <div class="cs_client_info">
                        <div class="cs_client_img">
                            <img src="{{ asset('frontpage/assets/img/user3.png') }}" alt="avatar1">
                        </div>
                        <div class="cs_client_meta">
                ...
                <div class="cs_testimonial cs_style_1">
                    <div class="cs_client_info">
                        <div class="cs_client_img">
                            <img src="{{ asset('frontpage/assets/img/user4.png') }}" alt="avatar1">
                        </div>
                        <div class="cs_client_meta">
                            <h4 class="cs_client_name">Wizard Bona</h4>
                            <p class="mb-0">Voila Caffe</p>
                ...
                <div class="cs_testimonial cs_style_1">
                    <div class="cs_client_info">
                        <div class="cs_client_img">
                            <img src="{{ asset('frontpage/assets/img/user5.png') }}" alt="avatar1">
                        </div>
                        <div class="cs_client_meta">
                            <h4 class="cs_client_name">Ansari Patron</h4>
                            <p class="mb-0">Green Lodge</p>
        ...
        <div class="container">
            ...
            <div class="cs_partners wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <div class="cs_partner">
                    <img src="{{ asset('frontpage/assets/img/brand_1.svg') }}" alt="Brand">
                </div>
                <div class="cs_partner">
                    <img src="{{ asset('frontpage/assets/img/brand_2.svg') }}" alt="Brand">
                </div>
                <div class="cs_partner">
                    <img src="{{ asset('frontpage/assets/img/brand_3.svg') }}" alt="Brand">
                </div>
                <div class="cs_partner">
                    <img src="{{ asset('frontpage/assets/img/brand_4.svg') }}" alt="Brand">
                </div>
                <div class="cs_partner">
                    <img src="{{ asset('frontpage/assets/img/brand_5.svg') }}" alt="Brand">
                </div>
                <div class="cs_partner">
                    <img src="{{ asset('frontpage/assets/img/brand_6.svg') }}" alt="Brand">
                </div>
            </div>
        </div>
        <div class="cs_height_150 cs_height_lg_80"></div>
        ...
        <section>
            <div class="container">
                <div class="cs_cta cs_style_1 text-center position-relative">
                    <div class="cs_cta_in">
                        <div class="cs_section_heading cs_style_1">
                            <h2 class="cs_section_title cs_text_white">Upgrade Your Business with Our <br> Cutting-Edge POS Solutions!
                            </h2>
                            <p class="cs_section_subtitle mb-0">Experience the future of transactions! Schedule a demo today and
                                witness how <br> our POS solution can revolutionize your business.
                            </p>
                        </div>
                    ...
                    <div class="cs_cta_shape1">
                        <img src="{{ asset('frontpage/assets/img/Ellipse_small.svg') }}" alt="">
                    </div>
                    <div class="cs_cta_shape2">
                        <img src="{{ asset('frontpage/assets/img/stroke.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="cs_accordian_wrap">
                            <div class="cs_accordian active">
                                ...
                                <div class="cs_accordian_body">
                                    To choose the right POS system, consider your business type, size, budget, required features, and
                                    potential
                                    for future
                                    growth. Research various options and read reviews to make an informed decision. Purchases and
                                    rewarding
                                    customers with
                                    points, discounts, or special offers.
                                </div>
                            </div>
                            <!-- .cs_accordian -->
                            <div class="cs_accordian">
                                ...
                                <div class="cs_accordian_body">
                                    To choose the right POS system, consider your business type, size, budget, required features, and
                                    potential
                                    for future growth. Research various options and read reviews to make an informed decision. Purchases
                                    and
                                    rewarding customers with points, discounts, or special offers.
                                </div>
                            </div>
                            <!-- .cs_accordian -->
                            <div class="cs_accordian">
            ...
            <div class="container">
                ...
                <div class="row wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s">
                    <div class="col-lg-4">
                        <div class="cs_post cs_style_1">
                            <div class="cs_post_thumb cs_modal_btn" data-modal="details">
                                <img src="{{ asset('frontpage/assets/img/blog1.jpg') }}" alt="Image">
                            ...
                            <div class="cs_post_content">
                                <div class="cs_post_content_in">
                                    <div class="cs_post_meta_wrap">
                                        <div class="cs_post_meta">
                                            <div class="cs_post_meta_icon">
                                                <img src="{{ asset('frontpage/assets/img/user.svg') }}" alt="Image">
                                            </div>
                                            <p class="mb-0">
                                                Admin
                                            </p>
                                        ...
                                        <div class="cs_post_meta">
                                            <div class="cs_post_meta_icon">
                                                <img src="{{ asset('frontpage/assets/img/label.svg') }}" alt="Image">
                                            </div>
                                            <p class="mb-0">
                                                Software
                                            </p>
                                ...
                                <div class="cs_post_user">
                                    ...
                                    <div class="cs_post_meta_wrap">
                                        <div class="cs_post_meta">
                                            <div class="cs_post_meta_icon">
                                                <img src="{{ asset('frontpage/assets/img/comment-dots.svg') }}" alt="Image">
                                            </div>
                                            <p class="mb-0">12</p>
                                        </div>
                                        <div class="cs_post_meta">
                                            <div class="cs_post_meta_icon">
                                                <img src="{{ asset('frontpage/assets/img/eye.svg') }}" alt="Image">
                                            </div>
                                            <p class="mb-0">50</p>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="cs_post cs_style_1">
                            <div class="cs_post_thumb cs_modal_btn" data-modal="details">
                                <img src="{{ asset('frontpage/assets/img/blog2.jpg') }}" alt="Image">
                    ...
                    <div class="col-lg-4">
                        <div class="cs_post cs_style_1">
                            <div class="cs_post_thumb cs_modal_btn" data-modal="details">
                                <img src="{{ asset('frontpage/assets/img/blog3.jpg') }}" alt="Image">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="cs_contact_thumb text-center">
                            <img src="{{ asset('frontpage/assets/img/contact_left.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6 wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="cs_section_heading cs_style_1">
                        ...
                        <form id="cs_form" class="row">
                            <div class="col-sm-6">
                                <input type="text" class="cs_form_field" placeholder="Full Name*" required="">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="cs_form_field" placeholder="Mobile*" required="">
                                <div class="cs_height_30 cs_height_lg_30"></div>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="cs_form_field" placeholder="Subject*" required="">
                                <div class="cs_height_30 cs_height_lg_30"></div>
                            </div>
                            <div class="col-lg-12">
                                <textarea rows="7" class="cs_form_field m-0" placeholder="Write Project Details*" required=""></textarea>
                                <div class="cs_height_30 cs_height_lg_30"></div>
                            </div>
                            <div class="col-lg-12">
        ...
        <div class="cs_modal_in">
            <div class="cs_modal_container cs_white_bg">
                ...
                <div class="cs_post_details cs_style_1">
                    ...
                    <img src="{{ asset('frontpage/assets/img/blog_details.jpg') }}" alt="blog1">
                                ...
                                <div class="comment_body">
                                    <div class="comment_meta">
                                        <div class="comment_author">
                                            <img src="{{ asset('frontpage/assets/img/comment1.jpg') }}" alt="comment1" class="avatar">
                                ...
                                <ol class="children">
                                    <li class="comment">
                                        <div class="comment_body">
                                            <div class="comment_meta">
                                                <div class="comment_author">
                                                    <img src="{{ asset('frontpage/assets/img/comment2.jpg') }}" alt="comment1" class="avatar">
            ...
            <div class="cs_modal_container">
                ...
                <div class="cs_login">
                    <div class="cs_login_container text-center">
                        <div class="cs_logo">
                            <img src="{{ asset('frontpage/assets/img/Poze.svg') }}" alt="Logo">
                        </div>
                        <form class="cs_login_form">
                            ...
                            <div class="cs_text_field">
                                <img src="{{ asset('frontpage/assets/img/envelop.svg') }}" alt="Icon">
                                <input type="text" class="cs_form_field" placeholder="Email address">
                            </div>
                            <div class="cs_text_field position-relative">
                                <img src="{{ asset('frontpage/assets/img/lock.svg') }}" alt="Icon">
                            ...
                            <div class="cs_social_btn cs_style_1 d-flex justify-content-center">
                                <a href="https://www.linkedin.com/" target="_blank">
                                    <img src="{{ asset('frontpage/assets/img/linkedin.svg') }}" alt="Icon">
                                </a>
                                <a href="https://www.twitter.com/" target="_blank">
                                    <img src="{{ asset('frontpage/assets/img/twitter.svg') }}" alt="Icon">
                                </a>
                                <a href="https://www.facebook.com/" target="_blank">
                                    <img src="{{ asset('frontpage/assets/img/facebook.svg') }}" alt="Icon">
                                </a>
                            </div>
                            <p class="mb-0">
    ...
    <footer class="cs_site_footer cs_color_1 cs_sticky_footer">
        <div class="cs_footer_shape1">
            <img src="{{ asset('frontpage/assets/img/Vector1.svg') }}" alt="Vector-Icon">
        </div>
        ...
        <div class="cs_main_footer">
                ...
                <div class="row">
                    <div class="col-lg-3 col-xl-4">
                        <div class="cs_footer_widget">
                            <div class="cs_text_field">
                                <img src="{{ asset('frontpage/assets/img/logo.svg') }}" alt="Logo" class="cs_footer_logo">
            ...
            <div class="container cs_copyright_text cs_text_white text-center">
                Copyright 2024. Design by<a href="" target="_blank" class="cs_site_link cs_text_accent"> Nafiur Rahman</a>
            </div>
        </div>
    </footer>
    <!--End Footer Section -->
    ...
    <!-- All Scripts Files -->
    <script src="{{ asset('frontpage/assets/js/jquery.min.js') }}"></script>
    <script src="{{ asset('frontpage/assets/js/jquery.slick.min.js') }}"></script>
