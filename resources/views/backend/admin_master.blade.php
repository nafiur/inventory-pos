            ...
            <ul class="nav user-menu">
                        ...
                        <form action="#" class="dropdown">
                            ...
                            <div class="dropdown-menu search-dropdown" aria-labelledby="dropdownMenuClickable">
                                ...
                                <div class="search-info">
                                    ...
                                    <ul class="customers">
                                        <li>
                                            <a href="javascript:void(0);">Aron Varu<img src="{{ asset('backend/assets/img/profiles/avator1.jpg') }}" alt class="img-fluid"></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">Jonita<img src="{{ asset('backend/assets/img/profiles/avatar-01.jpg') }}" alt class="img-fluid"></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">Aaron<img src="{{ asset('backend/assets/img/profiles/avatar-10.jpg') }}" alt class="img-fluid"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <li class="nav-item dropdown has-arrow flag-nav nav-item-box">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
                        <img src="{{ asset('backend/assets/img/flags/us.png') }}" alt="Language" class="img-fluid">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
